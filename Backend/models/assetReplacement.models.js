...
const assetReplacementSchema = new mongoose.Schema(
    {
        ...
        employee: { type: mongoose.Schema.Types.ObjectId, ref: "User", required: true }, // Changed to "User" for consistency
        ...
        createdBy: { type: mongoose.Schema.Types.ObjectId, ref: "User", required: true }, // Tracks who created the request
    },
    { timestamps: true }
);
